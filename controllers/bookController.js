...
exports.index = function(req, res, next) {   
    ...
    async.parallel({ //batch production
        book_count: function(x) {
           Book.count(x);
        },
...
exports.book_delete_get = function(req, res, next) {
    ...
    async.parallel({
      ...
      instances_book: function(callback){
      ...
      res.render('book_delete', { title: 'Delete Book', book: results.book, book_instances: results.instances_book});
